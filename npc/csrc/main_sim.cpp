...
// === Verilator Core Headers ===
#include "verilated.h"
#include "verilated_fst_c.h"

// === DPI-C Interface Headers ===
#if defined(MODULE_DPI_C_EXAMPLE)
#include "svdpi.h"                    // Needed for SystemVerilog DPI-C type definitions
#include "Vdpi_c_example__Dpi.h"      // DPI-C function prototypes generated by Verilator
#endif

#if defined(MODULE_YSYX_V1_TOPPROCADDI)
#include "svdpi.h"                    // Needed for SystemVerilog DPI-C type definitions
#include "Vysyx_v1_TopProcAddi__Dpi.h"   // DPI-C function prototypes generated by Verilator
#endif

#if defined(MODULE_YSYX_V2_TOPPROC_ADDI_JALR)
#include "svdpi.h"                    // Needed for SystemVerilog DPI-C type definitions
#include "Vysyx_v1_TopProcAddi__Dpi.h"   // DPI-C function prototypes generated by Verilator
#endif
...
// C implementation of add() for use in vsrc/dpi_c_example.v via DPI-C
...
#elif defined(MODULE_YSYX_V1_TOPPROCADDI)
    // Apply reset
    top->rstn = 0;
    step_and_dump_wave();
    top->rstn = 1;
...
#elif defined(MODULE_YSYX_V2_TOPPROC_ADDI_JALR)
    // Apply reset
    top->rstn = 1;
    step_and_dump_wave();
    top->rstn = 0;
...
#elif defined(MODULE_DPI_C_EXAMPLE)
    for (int i = 0; i < 10; i++) {
        step_and_dump_wave();
    }
#endif
